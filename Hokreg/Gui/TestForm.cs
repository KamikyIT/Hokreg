...
namespace Uniso.InStat.Gui
{
    public partial class TestForm : Form
    {
        ...
        void streamPlayer1_PositionChanged(object sender, Players.StreamPlayer.PositionEventArgs e)
        {
            try
            {
        ...
        {
            if (streamPlayer1.Mode == Players.StreamPlayer.PlayerMode.Play)
                streamPlayer1.Mode = Players.StreamPlayer.PlayerMode.Pause;
            else
                streamPlayer1.Mode = Players.StreamPlayer.PlayerMode.Play;
        }
